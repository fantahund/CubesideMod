...
public class ConfigMenu implements ModMenuApi {
    ...
    static class Builder {
        Screen build(Screen parent) {
            ...
            general.addEntry(entryBuilder.startIntField(new TranslatableText("options.cubeside.daysthemessagesarestored"), Config.daystheMessagesareStored).setDefaultValue(10).setSaveConsumer(integer -> Config.daystheMessagesareStored = integer).build());
